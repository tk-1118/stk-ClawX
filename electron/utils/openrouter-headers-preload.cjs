 ...
 * "openrouter.ai" carries the HNClaw app-attribution headers.
 *
...
(function () {
  ...
  if (globalThis.__HNClawFetchPatched) return;
  globalThis.__HNClawFetchPatched = true;

  globalThis.fetch = function HNClawFetch(input, init) {
    var url =
