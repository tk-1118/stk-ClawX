 ...
 * "openrouter.ai" carries the STKClaw app-attribution headers.
 *
...
(function () {
  ...
  if (globalThis.__STKClawFetchPatched) return;
  globalThis.__STKClawFetchPatched = true;

  globalThis.fetch = function STKClawFetch(input, init) {
    var url =
