...
if /i "%1"=="update" (
    echo openclaw is managed by HNClaw ^(bundled version^).
    echo.
    echo To update openclaw, update HNClaw:
    echo   Open HNClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=HNClaw
"%~dp0..\..\HNClaw.exe" "%~dp0..\openclaw\openclaw.mjs" %*
