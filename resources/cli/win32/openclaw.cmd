...
if /i "%1"=="update" (
    echo openclaw is managed by STKClaw ^(bundled version^).
    echo.
    echo To update openclaw, update STKClaw:
    echo   Open STKClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=STKClaw
"%~dp0..\..\STKClaw.exe" "%~dp0..\openclaw\openclaw.mjs" %*
